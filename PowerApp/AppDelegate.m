...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    PADataManager *data = [PADataManager sharedInstance];
    
    if ([data fetchPowerStatesForAge:PADataManagerFetchAgeAll].count == 0) {
        
        [data generatePowerStatesWithCompletionBlock:nil];
